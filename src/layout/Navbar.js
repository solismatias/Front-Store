      ...
      <div className='navbar__container'>
        <nav className='navbar'>
          ...
          <ul className='navbar__list navbar__list--right'>
            ...
            {this.state.isCurrencyOpen ? <Currency close={this.openCloseCurrency} /> : null}
            <li className='navbar__item navbar__cart' onClick={this.openCloseCart}>
              {this.state.isCartOpen ?
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"><path fillRule="evenodd" d="M5.72 5.72a.75.75 0 011.06 0L12 10.94l5.22-5.22a.75.75 0 111.06 1.06L13.06 12l5.22 5.22a.75.75 0 11-1.06 1.06L12 13.06l-5.22 5.22a.75.75 0 01-1.06-1.06L10.94 12 5.72 6.78a.75.75 0 010-1.06z" /></svg>
                :
                <>
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 20 19" fill="none" stroke="none">
            ...
            {this.state.isCartOpen ? <MiniCart close={this.openCloseCart} /> : null}
          </ul>
        </nav>
      </div >
    )
